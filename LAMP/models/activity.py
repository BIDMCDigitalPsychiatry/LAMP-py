...
try:
    from LAMP.models import duration_interval_legacy
except ImportError:
    duration_interval_legacy = sys.modules[
        'LAMP.models.duration_interval_legacy']
...
class Activity(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'spec': (str,),
            'name': (str,),
            'schedule': (duration_interval_legacy.DurationIntervalLegacy,),
            'settings': (bool, date, datetime, dict, float, int, list, str,),
        }
    ...
    def __init__(self, _check_type=True, _from_server=False, _path_to_item=(), _configuration=None, **kwargs):
        """activity.Activity - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            schedule (duration_interval_legacy.DurationIntervalLegacy): [optional]
