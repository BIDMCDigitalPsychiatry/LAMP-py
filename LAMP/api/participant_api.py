...
from LAMP.models import participant
    ...
    def __init__(self, api_client=None):
        ...
        self.all_by_researcher = Endpoint(
            settings={
                ...
                'endpoint_path': '/researcher/{researcher_id}/participant',
        ...
        self.all_by_study = Endpoint(
            settings={
                ...
                'endpoint_path': '/study/{study_id}/participant',
        ...
        def __create(
            ...
            **kwargs
            ...
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True
            >>> thread = api.create(study_id, participant_participant, async_req=True)
            >>> result = thread.get()
            ...
            kwargs['study_id'] = \
                study_id
            kwargs['participant_participant'] = \
                participant_participant
            return self.call_with_http_info(**kwargs)
        ...
        self.delete = Endpoint(
            settings={
                ...
                'endpoint_path': '/participant/{participant_id}',
                'operation_id': 'delete',
                'http_method': 'DELETE',
                'servers': [],
            },
        ...
        def __update(
            ...
            **kwargs
            ...
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True
            >>> thread = api.update(participant_id, participant_participant, async_req=True)
            >>> result = thread.get()
        ...
        def __view(
            ...
            **kwargs
            ...
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True
            >>> thread = api.view(participant_id, async_req=True)
            >>> result = thread.get()
