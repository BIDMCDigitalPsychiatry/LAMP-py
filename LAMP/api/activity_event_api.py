...
from LAMP.models import activity_event


class ActivityEventApi(object):
    """
    """
    ...
    def __init__(self, api_client=None):
        ...
        self.all_by_participant = Endpoint(
            settings={
                ...
                'endpoint_path': '/participant/{participant_id}/activity_event',
        ...
        self.all_by_researcher = Endpoint(
            settings={
                ...
                'endpoint_path': '/researcher/{researcher_id}/activity_event',
        ...
        self.all_by_study = Endpoint(
            settings={
                ...
                'endpoint_path': '/study/{study_id}/activity_event',
        ...
        def __create(
            ...
            **kwargs
            ...
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True
            >>> thread = api.create(participant_id, activity_event_activity_event, async_req=True)
            >>> result = thread.get()

            Args:
                participant_id (str):
                activity_event_activity_event (activity_event.ActivityEvent):
            ...
            kwargs['participant_id'] = \
                participant_id
            kwargs['activity_event_activity_event'] = \
                activity_event_activity_event
            return self.call_with_http_info(**kwargs)
        ...
        self.create = Endpoint(
            ...
            root_map={
                ...
                'location_map': {
                    'participant_id': 'path',
                    'activity_event_activity_event': 'body',
                },
                'collection_format_map': {
                }
            },
