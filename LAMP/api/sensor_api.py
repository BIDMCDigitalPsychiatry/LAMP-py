...
from LAMP.models import sensor
    ...
    def __init__(self, api_client=None):
        ...
        self.all_by_participant = Endpoint(
            settings={
                ...
                'endpoint_path': '/participant/{participant_id}/sensor',
        ...
        self.all_by_researcher = Endpoint(
            settings={
                ...
                'endpoint_path': '/researcher/{researcher_id}/sensor',
        ...
        self.all_by_study = Endpoint(
            settings={
                ...
                'endpoint_path': '/study/{study_id}/sensor',
        ...
        def __create(
            ...
            **kwargs
            ...
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True
            >>> thread = api.create(study_id, sensor_sensor, async_req=True)
            >>> result = thread.get()
        ...
        def __delete(
            ...
            **kwargs
            ...
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True
            >>> thread = api.delete(sensor_id, async_req=True)
            >>> result = thread.get()
        ...
        self.delete = Endpoint(
            settings={
                ...
                'endpoint_path': '/sensor/{sensor_id}',
                'operation_id': 'delete',
                'http_method': 'DELETE',
                'servers': [],
            },
        ...
        def __update(
            ...
            **kwargs
            ...
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True
            >>> thread = api.update(sensor_id, sensor_sensor, async_req=True)
            >>> result = thread.get()
        ...
        def __view(
            ...
            **kwargs
            ...
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True
            >>> thread = api.view(sensor_id, async_req=True)
            >>> result = thread.get()
